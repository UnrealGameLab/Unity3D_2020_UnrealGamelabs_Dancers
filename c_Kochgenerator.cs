...
public class c_Kochgenerator : MonoBehaviour
{
    ...
    public StartGen[] _startGen; // Initialised the STARTGEN as an ARRAY
    ...
    
    {
        ...
        // FOO_Changed_in_Video_Part_V ---
        for (int i = 0; i < _startGen.Length; i++) // Loop through Length of --  STARTGEN -- ARRAY
        {
            KochGenerate(_targetPosition, _startGen[i].outwards, _startGen[i].scale); // _startGen - at its current position
        }
